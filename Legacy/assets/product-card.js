...
function toggleCustomTextInput() {
  var checkbox = document.getElementById('add-custom-text');
  var inputDiv = document.getElementById('custom-text-input');
  inputDiv.style.display = checkbox.checked ? 'block' : 'none';
}
function toggleDesignColorsInput() {
  var checkbox = document.getElementById('modify-design-colors');
  var inputDiv = document.getElementById('design-colors-input');
  inputDiv.style.display = checkbox.checked ? 'block' : 'none';
}
</script>
