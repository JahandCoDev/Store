// telephony/src/app/login/page.tsx
"use client";
          ...
          <div>
            <div className="inline-flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Voice Panel</p>
              </div>
            </div>

            <h1 className="mt-10 text-4xl font-bold tracking-tight text-white">
              Secure access to your voice operations.
            </h1>
            <p className="mt-4 max-w-md text-sm leading-6 text-gray-400">
              Answer calls, transfer callers, and manage your telephony queue — all in one place.
              Access is restricted to admin accounts.
            </p>

            <div className="mt-10 grid max-w-md grid-cols-1 gap-4">
              <div className="rounded-xl border border-gray-800 bg-gray-900/40 p-4">
                <p className="text-sm font-medium text-gray-200">LiveKit WebRTC</p>
                <p className="mt-1 text-xs text-gray-400">Browser-native audio — no plugin required.</p>
              </div>
              <div className="rounded-xl border border-gray-800 bg-gray-900/40 p-4">
                <p className="text-sm font-medium text-gray-200">Push notifications</p>
                <p className="mt-1 text-xs text-gray-400">Ring your phone or desktop when calls come in.</p>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-2xl border border-gray-800 bg-gray-900/70 p-8 shadow-lg ring-1 ring-black/30">
              ...
              <form className="mt-6 space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      autoComplete="email"
                      className="block w-full rounded-md border border-gray-800 bg-gray-950 px-3 py-2 text-sm text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-800/40"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex w-full items-center justify-center rounded-md bg-blue-900 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-800/60 focus:ring-offset-2 focus:ring-offset-black disabled:opacity-50"
                >
                  {loading ? "Signing in…" : "Sign in"}
                </button>

                <p className="text-xs text-gray-500">
                  Access is restricted to admin accounts. Contact your system administrator if you need access.
                </p>
              </form>
            </div>
          </div>
