        ...
        <div className="hidden w-1/2 flex-col justify-between py-12 pr-10 lg:flex">
          <div>
            ...
            <p className="mt-4 max-w-md text-sm leading-6 text-gray-400">
              Manage customers, products, orders, and fulfillment in one place. Access is restricted to admin accounts.
            </p>

            <div className="mt-10 grid max-w-md grid-cols-1 gap-4">
              <div className="rounded-xl border border-gray-800 bg-gray-900/40 p-4">
                <p className="text-sm font-medium text-gray-200">Multi-shop ready</p>
                <p className="mt-1 text-xs text-gray-400">Switch between shops without mixing data.</p>
              </div>
              <div className="rounded-xl border border-gray-800 bg-gray-900/40 p-4">
                <p className="text-sm font-medium text-gray-200">Audit-friendly workflows</p>
                <p className="mt-1 text-xs text-gray-400">Designed for operational clarity and control.</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="rounded-2xl border border-gray-800 bg-gray-900/70 p-8 shadow-lg ring-1 ring-black/30">
              ...
              <form className="mt-6 space-y-5" onSubmit={handleSubmit}>
                ...
                <p className="text-xs text-gray-500">
                  Access is restricted to admin accounts. If you believe this is an error, contact your system administrator.
                </p>
              </form>
            </div>
          </div>
